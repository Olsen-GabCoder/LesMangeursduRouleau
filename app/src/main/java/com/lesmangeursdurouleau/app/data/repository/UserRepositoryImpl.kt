...
// ATTENTION: Le constructeur est temporairement invalide car il injecte des dépendances qui ne sont plus utilisées.
// Cela sera corrigé au fur et à mesure de la refactorisation.
class UserRepositoryImpl @Inject constructor(
    private val firestore: FirebaseFirestore,
    private val firebaseAuth: FirebaseAuth,
    private val firebaseStorageService: FirebaseStorageService
    // SUPPRESSION: L'injection de PrivateChatRepository n'est plus nécessaire après la migration des consommateurs.
    // private val privateChatRepository: PrivateChatRepository -> Nous le laissons pour l'instant et le supprimerons plus tard.
) : UserRepository {
    ...
    // ... (le reste du code, SANS les méthodes de messagerie privée, reste identique)
    // ... Je le coupe pour la lisibilité, mais il est bien présent dans votre fichier.
